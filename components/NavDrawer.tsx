...
import {
  ...
  Info, LogOut, User, X, Menu,
} from "lucide-react";
import Link from "next/link";
import { motion, AnimatePresence } from "framer-motion";
import { supabase } from "@/lib/supabase"; // ✅ Jamais de clé en dur
  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-[13px] font-bold hidden sm:block">Menu</span>
            ...
            <div className="relative px-6 pt-6 pb-5 border-b border-white/[0.05]
              ...
              <div className="flex items-center gap-4">
                <div className="relative flex-shrink-0">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500/30 to-violet-500/20
                    border border-cyan-500/20 flex items-center justify-center overflow-hidden shadow-lg">
                    {userData.avatar ? (
                  ...
                  >
                    ...
                    >
                      ...
                      {active && (
                        <motion.div
                          layoutId="nav-active"
                          className={`ml-auto text-[10px] font-black uppercase tracking-widest px-2 py-0.5
                            rounded-full ${item.bg} ${item.color} border ${item.border}`}
                        >
                          Actif
                        </motion.div>
                      )}
